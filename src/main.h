...
static const uint256 hashGenesisBlock("00000664df134ea512bf39c322204f91eacfdb406c9227b06f78fce03da16559");
static const uint256 hashGenesisBlockTestNet("");
inline int64_t PastDrift(int64_t nTime)   { return nTime - 60 * 60; }
inline int64_t FutureDrift(int64_t nTime) { return nTime + 60 * 60; }
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nAmount) const;  // ppcoin: get transaction coin age
