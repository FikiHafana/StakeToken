...
const string strMessageMagic = "StakeToken Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "StakeToken", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "zondag 5 juni 2016 bb04755b-359c-495d-b621-3dce217dab94";
        CTransaction txNew;
        txNew.nTime = 1465133611;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1465133611;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 2276503 ;
		if(fTestNet)
        {
            block.nNonce = 2276503 ;
        }
		
		uint256 nhashMerkleRoot = uint256("0xaa31790e6c3ab4bd9453f97719059dba5189406b3e84dfa989024d16ad77f9e7");
